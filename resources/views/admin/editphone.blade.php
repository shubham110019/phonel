              ...
              @endforeach
                ...
                <div class="form-group col-md-4">
                 ...
                 <div class="form-group col-md-4">
                  ...
                  <input type="text" class="form-control" name="facelook"  value="{{$edit->facelook}}">
                  
                </div>

                 <div class="form-group col-md-4">
                  <label for="exampleInputEmail1"><b>fingerprint lock</b></label>
                  <input type="text" class="form-control" name="fingerlock"  value="{{$edit->fingerlock}}">
                ...
                <div class="form-group col-md-3">
                  ...
                  <input type="text" class="form-control" name="processor"  value="{{$edit->processor}}">
                ...
                <div class="form-group col-md-3">
                  ...
                  <input type="text" class="form-control" name="batteryc"  value="{{$edit->batteryc}}">
