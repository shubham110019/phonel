  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <hr class="sidebar-divider">
       ...
       <li class="nav-item">
        <a class="nav-link" href="{{url('/')}}/admin/alldevice">
          <i class="fas fa-fw fa-chart-area"></i>
          <span>Add Device</span></a>
      </li>

        <li class="nav-item">
        <a class="nav-link" href="{{url('/')}}/admin/allcategory">
          <i class="fas fa-fw fa-chart-area"></i>
      ...
      <li class="nav-item">
        <a class="nav-link" href="{{url('/')}}/admin/pickview">
          <i class="fas fa-fw fa-chart-area"></i>
          <span>Pick Phone</span></a>
      </li>

       <li class="nav-item">
        <a class="nav-link" href="{{url('/')}}/admin/phonebooks">
          <i class="fas fa-fw fa-chart-area"></i>
          <span>Phone Book</span></a>
      </li>

        <li class="nav-item">
        <a class="nav-link" href="{{url('/')}}/admin/repairbooks">
          <i class="fas fa-fw fa-chart-area"></i>
          <span>Repair Book</span></a>
      </li>
       ...
       <li class="nav-item">
        <a class="nav-link" href="{{url('/')}}/admin/partnerview">
          <i class="fas fa-fw fa-chart-area"></i>
